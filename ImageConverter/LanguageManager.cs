...
namespace ImageConverter
{
    class LanguageManager
    {
        ...
        public static readonly string IT_WarningLabelTxt = "⚠ Solo la prima immagine verrà convertita";
        ...
        public static readonly string EN_WarningLabelTxt = "⚠ Only the first image will be converted";
